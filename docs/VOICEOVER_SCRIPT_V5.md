...
For **`media/executor-demo-v5-silent.mp4`** (3:58). Supersedes v3, which was
...
Target **≤ 4:00**: The Graph requires two to four minutes and treats it as an
eligibility rule. You have two seconds of margin, so watch your total.
...
### 1:08 — it exists, and it is beating
...
### 2:28 — the destination changed  ← **the shot**
