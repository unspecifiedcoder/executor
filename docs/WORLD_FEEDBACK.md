...
filing on a World ID proof) was never built, and the project has no
creditor-facing claim filing at all — `Estate.registerClaim` is trustee-only by
design. That stub directory has since been deleted; git history has it.
